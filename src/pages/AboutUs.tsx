            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  ...
                  us a trusted partner for businesses across Maharashtra. We
                  operate 24/7 to ensure our clients receive support whenever
                  they need it.
                </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Professional engineering services provider in Mumbai, offering
                24/7 solutions for all your industrial needs.
              </p>
