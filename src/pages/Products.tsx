  ...
  const products = [
    {
      ...
      description:
        "British Standard Pipe fittings for hydraulic applications with precise threading",
      features: [
        "BSP threading standard",
        "High pressure rated",
        "Corrosion resistant",
    ...
    },
    {
      ...
      description:
        "Joint Industry Council fittings with 37-degree flare connections",
      features: [
    ...
    },
    {
      ...
      description:
        "Metric standard fittings compatible with European hydraulic systems",
      features: [
    ...
    },
    {
      ...
      description:
        "O-Ring Face Seal fittings for high-pressure hydraulic applications",
      features: [
        "O-ring face seal",
    ...
    },
    {
      ...
      description:
        "Tailor-made hose assemblies for specific industrial applications",
      features: [
        "Custom lengths",
    ...
    },
    {
      ...
      name: "SS Bellows",
      description:
        "Stainless steel bellows for high-temperature and corrosive environments",
      features: [
      ...
      image:
        "https://img2.exportersindia.com/product_images/bc-full/2023/11/707744/stainless-steel-bellow-1684313875-916386.jpg",
    },
    {
      category: "specialty",
      name: "Teflon Hoses",
      ...
      image:
        "https://www.metline-pipefittings.in/wp-content/uploads/2018/03/PTFE-TEFLON-Hose-Pipes-Manufacturers-Suppliers-Factory-India.jpg",
    },
    {
      category: "specialty",
      name: "High Pressure Hydraulic Hoses",
      description:
        "Extra high-pressure hoses for demanding industrial applications",
      features: [
      ...
      image:
        "https://5.imimg.com/data5/SELLER/Default/2020/10/ZU/YQ/GL/4782107/high-pressure-hydraulic-hoses.jpg",
    },
    {
      category: "specialty",
      name: "Carbon-Free & Food-Grade Hoses",
      description:
        "Specialized hoses for food processing and pharmaceutical industries",
      features: [
        "FDA compliance",
      ...
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEhh2HTwrlkvmOx8X93lurzvZaKyEwzxfK8y0LEYfcZwBUsGrkwyqnXF-2iVT6Bdbuce4&usqp=CAU",
    },
    {
    ...
    },
    {
      ...
      description:
        "Advanced piling equipment with hydraulic rotary drive system",
      features: [
        "Max depth 35m",
    ...
    },
    {
      ...
      description:
        "Industrial-grade crimping machine for on-site hose assembly",
      features: [
        "Multi-die system",
        "Precision crimping",
        "Portable design",
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-lg">
                Emergency hydraulic hose repair with battery-operated crimping
                van
              </p>
            </div>
            <button
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div
                className="bg-white p-6 rounded-xl shadow-lg animate-scale-in"
